...
CON_HADOOP_NAMENODE1_VOL_SV_LOGS=$HOST_VOL/hadoop/supervisord/logs:/var/log/supervisord
...
CON_HADOOP_NAMENODE2_VOL_HD_TEMP=$HOST_VOL/hadoop/namenode/hdfs:/opt/hadoop/hdfs
CON_HADOOP_NAMENODE2_VOL_SV_LOGS=$HOST_VOL/hadoop/supervisord/logs:/var/log/supervisord
...
CON_HADOOP_DATANODE1_VOL_SV_LOGS=$HOST_VOL/hadoop/supervisord/logs:/var/log/supervisord
...
CON_HADOOP_DATANODE2_VOL_SV_LOGS=$HOST_VOL/hadoop/supervisord/logs:/var/log/supervisord
